...
// ar框架目录
defined('AR_FRAME_PATH') or define('AR_FRAME_PATH', dirname(__FILE__) . DS . 'src' . DS);
// 项目根目录
...
require_once AR_CORE_PATH . 'Ar.php';

spl_autoload_register('\\ar\\core\\Ar::autoLoader');
